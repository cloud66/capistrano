...
def shared_manifest_path
  @shared_manifest_path ||= capture("ls #{shared_path.shellescape}/#{shared_assets_prefix}/manifest* &> /dev/null || touch #{shared_path.shellescape}/#{shared_assets_prefix}/manifest.yml ; ls #{shared_path.shellescape}/#{shared_assets_prefix}/manifest*").strip
end
